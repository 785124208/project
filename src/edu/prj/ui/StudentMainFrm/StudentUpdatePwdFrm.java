...
public class StudentUpdatePwdFrm extends JFrame{
...
//			return;
//		}
		Student bean2=studentService.loadByName(loginName);
		if(bean2==null) {
...
//		}
		...
		bean2.setLoginPwd(SysFun.md5(newpwd));
		Long result=0L;
		String errMsg=null;
		try {
		result=studentService.updatepwd(bean2);
		}catch(Exception ex) {
