...
public class ExamListFrm extends JFrame implements java.io.Serializable{
...
//		String searchBook=txtSearchBook.getText();
		if(searchName!=null&&searchName.isEmpty()) {
			list=examService.listById(pk);
		}
		else {
			list=examService.list();
		}
		ATableModel<Exam> tableModel = null;
		tableModel = new ATableModel<Exam>(list, 7) {

			@Override
			public Object getPropValue(Exam bean, int columIndex) {
				// TODO Auto-generated method stub
...
//		ExamInsertFrm paperInsertFrm=new ExamInsertFrm();
...
//			Long pk=Long.valueOf(""+obj);
//			if(pk>0) {
////				ExamUpdateFrm studentUpdateFrm=new ExamUpdateFrm();
